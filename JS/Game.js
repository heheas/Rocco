class Game {
  homeLocations = [{x:3, y:0},{x:0, y:4},{x:6, y:4}, {x:0, y:8},{x:6, y:8},{x:3, y:12}];
  ...
  tileLocations = [
    ...
    {x:1, y:5},{x:1, y:5},{x:2, y:5},{x:3, y:5},{x:4, y:5},{x:5, y:5},
    {x:1, y:6},{x:1, y:6},{x:2, y:6},{x:3, y:6},{x:4, y:6},{x:5, y:6},
    {x:1, y:7},{x:1, y:7},{x:2, y:7},{x:3, y:7},{x:4, y:7},{x:5, y:7},
    {x:1, y:8},{x:1, y:8},{x:2, y:8},{x:4, y:8},{x:5, y:8},{x:5, y:8},
    {x:1, y:9},{x:1, y:9},{x:2, y:9},{x:3, y:9},{x:4, y:9},{x:5, y:9},
    {x:1, y:10},{x:1, y:10},{x:2, y:10},{x:4, y:10},{x:5, y:10},{x:6, y:10},
    {x:1, y:11},{x:1, y:11},{x:2, y:11},{x:3, y:11},{x:4, y:11},
